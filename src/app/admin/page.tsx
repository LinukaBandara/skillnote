        ...
        <ul className="border-t border-rule">
          <li className="border-b border-rule">
            <Link href="/admin/courses" className="flex items-center justify-between py-5 group">
              <div><h2 className="text-base font-medium group-hover:text-cobalt transition-colors">Courses</h2><p className="text-sm text-ink-soft mt-1">{courseCount ?? 0} course{courseCount === 1 ? "" : "s"}</p></div>
          ...
          <li className="border-b border-rule">
            <Link href="/admin/mock-exams" className="flex items-center justify-between py-5 group">
              <div><h2 className="text-base font-medium group-hover:text-cobalt transition-colors">Mock exams</h2><p className="text-sm text-ink-soft mt-1">{examCount ?? 0} exam{examCount === 1 ? "" : "s"}</p></div>
              <span className="text-sm text-ink-faint group-hover:text-cobalt transition-colors">Manage</span>
            </Link>
          </li>
          {profile.role === "platform_admin" && (
            <li className="border-b border-rule">
              <Link href="/admin/syllabus" className="flex items-center justify-between py-5 group">
                <div><h2 className="text-base font-medium group-hover:text-cobalt transition-colors">Syllabus</h2><p className="text-sm text-ink-soft mt-1">Versions, subtopics and learning outcomes</p></div>
                <span className="text-sm text-ink-faint group-hover:text-cobalt transition-colors">Manage</span>
              </Link>
            </li>
          )}
          <li className="border-b border-rule">
            <Link href="/admin/students" className="flex items-center justify-between py-5 group">
              <div><h2 className="text-base font-medium group-hover:text-cobalt transition-colors">Students</h2><p className="text-sm text-ink-soft mt-1">Performance and activity overview</p></div>
